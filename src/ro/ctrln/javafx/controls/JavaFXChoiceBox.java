...
public class JavaFXChoiceBox extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        choiceBox.getItems().addAll(Arrays.asList("Lab1","Lab2","Lab3"));
        ...
        choiceBox.setOnAction(event -> {
            ...
            System.out.println("Am selectat optiunea: " + selection + " de la indexul: " + index);
        });

        CheckBox checkBox = new CheckBox("Arata ChoiceBox");
        checkBox.setSelected(false);
        checkBox.setOnAction(e -> choiceBox.setVisible(!choiceBox.isVisible()));
